...
## <span style="color:red">1) Voltando a um commit (Revert / Reset) - Roteiro 1 (ainda) âœ…</span>
...
---
## <span style="color:red">2) ConvenÃ§Ãµes de **Git SemÃ¢ntico** (Conventional Commits) âœ…</span>
...
## <span style="color:red"> 3) Trabalhando com `git stash` âœ…</span>
...
## <span style="color:red">4) ConvenÃ§Ãµes de **nomenclatura** de branches âœ…</span>
...
## <span style="color:red"> 5) Criar branch a partir da `main` âœ…</span>
...
## <span style="color:red">6) Ciclo de commits (aplicando Git SemÃ¢ntico) âœ…</span>
...
---
## <span style="color:red">7) Manter sua branch atualizada (rebase recomendado) âœ…</span>
